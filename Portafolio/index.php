...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/icon-portfolio.png" rel="icon">
...
<!--           <p>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea. Quia fugiat sit in iste officiis commodi quidem hic quas.</p> -->
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            <h3>Analista de Sistemas &amp; Desarrollador Web.</h3>
            <p class="fst-italic">
              Soy capaz de adaptarme a cualquier circunstancia y dar siempre lo mejor de mí en cualquier proyecto, al mismo tiempo que me esfuerzo por trabajar en equipo y fomentar valores como los del compañerismo.
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Fecha de Nacimiento:</strong> <span>20 Jul 1986</span></li>
                  <!-- <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>www.example.com</span></li> -->
                  <li><i class="bi bi-chevron-right"></i> <strong>Celular:</strong> <span>+57 310 8830579</span></li>
            ...
            <p>
              Soy una persona dinámica, con metas claras, aprendo con facilidad, cumplo mis funciones de manera 
              responsable honesta y puntual bajo las normas laborales establecidas.
              Estoy en búsqueda de una empresa donde pueda aplicar los conocimientos adquiridos y me otorgue la oportunidad 
              de continuar con mi proyecto de vida en el ámbito profesional.
            </p>
          </div>
        </div>
    ...
    <section id="skills" class="skills section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Skills</h2>
          <p><q><em>La innovación constante es la única forma de mantenerse competitivo, porque ninguna ventaja es sostenible en el largo plazo</em></q><cite><strong> Jorge Gonzales Moore</strong></cite></p>
        </div>
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="progress">
              <span class="skill">Data Bases<i class="val">60%</i></span>
              <div class="progress-bar-wrap">
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="resume-item pb-0">
              <h4>Jorge Triana</h4>
              <p><em>Gracias a mi formación especializada, considero que puedo aportar valor y seguir desarrollándome profesionalmente en una compañía que coincida con mis valores y expectativas.</em></p>
            </div>
            ...
            <div class="resume-item">
              ...
              <h5>2018 - 2020</h5>
              <p><em>Sena CEET</em></p>
              <p>ciclo de vida de desarrollo de softwre, diagramas(clases, mer, historias de usuarios..), mockups, documentación(casos de uso, req funcionales y no funcionales, dicc. de datos...), manual de usuario, programación de aplicativo web en php, html, css3, DB phpmyadmin,</p>
            </div>
            <div class="resume-item">
              <h4>Técnico en programación de software</h4>
              <h5>2016 - 2017</h5>
              <p><em>Sena CEET</em></p>
              <p>Programación en java y c#, algoritmos y programación orientada a objetos, desarrollo de aplicativo web con visual studio y c# bajo el modelo MVC</p>
            </div>
          </div>
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <h3 class="resume-title">Experiencia Profesional</h3>
            <div class="resume-item">
              <h4>analista de calidad -tester qa</h4>
              <h5>2020 - 2020</h5>
              <p><em>Tivit-ETB</em></p>
              <ul>
                <li>Desarrollo de casos de prueba</li>
                <li>Pruebas de software </li>
                <li>Manejo de Metodologia Scrum</li>
                <li>Reuniones con clientes que reportan nececidades e incidentes para entregar la solución</li>
              </ul>
            </div>
            <div class="resume-item">
              <h4>analista de sistemas</h4>
              <h5>2019 - 2019</h5>
              <p><em>Tivit-Ecopetrol</em></p>
              <ul>
                <li>realización de informes</li>
                <li>análisis de requerimientos y su debida asignación a consultores SAP</li>
                <li>solucion de requerimientos</li>
            ...
            <div class="resume-item">
              <h4>tester QA</h4>
              <h5>2017 - 2018</h5>
              <p><em>4sight - MAPFRE</em></p>
              <ul>
                <li>Desarrollo de puebas de software según requerimientos</li>
                <li>Elaboración de reportes</li>
                <li>manejo de coverall, citrix, tronweb  </li>
                <!-- <li>Created 4+ design presentations and proposals a month for clients and account managers</li> -->
              </ul>
            </div>
          </div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Dirección:</h4>
                <p>Carrera 19b # 56 - 86 sur, Bogotá</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>jorgetriana1951@hotmail.com</p>
              </div>
...
<!--               <iframe src="https://www.google.com/maps/place/Cra.+19b+%2356-86,+Bogotá/@4.5698988,-74.1355303,16z/" frameborder="0" style="border:0; width: 100%; height: 290px;" allowfullscreen></iframe> -->
            </div>

          </div>

          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form action="/forms/enviar.php" method="post" role="form" class="php-email-form">
              <div class="row">
