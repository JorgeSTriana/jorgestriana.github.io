            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/portfolio/img-portafolio.PNG" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/img-portafolio-about.PNG" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/detalle-project.PNG" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Project date</strong>: 15 October, 2021</li>
                <li><strong>Project URL</strong>: <a href="#"></a></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>Detalle de Portafolio Web</h2>
              <p>
                Portafolio realizado en html, css, responsive
              </p>
              <!-- <a href="https://github.com/JorgeSTriana/Portafolio-Template" target="_blank" class="google-plus"><i class="bx bxl-github"></i></a> -->
              <a href="https://github.com/JorgeSTriana/Portafolio-Template" target="_blank"><img src="https://img.icons8.com/ios-filled/100/000000/github.png"/>GitHub</a>
            </div>
          </div>
